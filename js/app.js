...
const app = {
    ...
    login: async function () {
        ...
        // Secure authentication check using SHA-256
        if (!window.crypto || !window.crypto.subtle) {
            return alert("Error de seguridad: Tu navegador no soporta criptografía segura o no estás en un contexto seguro (HTTPS/localhost).");
        }
