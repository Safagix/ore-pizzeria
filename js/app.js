...
const app = {
    ...
    login: async function () {
        ...
        // Security: Check for Web Crypto API support (Secure Context required)
        if (!window.crypto || !window.crypto.subtle) {
            return alert("Error de Seguridad: El navegador no soporta criptografía segura o no estás en una conexión segura (HTTPS).");
        }

        // Security: Hashed PIN comparison (Defense against cleartext PINs in source)
