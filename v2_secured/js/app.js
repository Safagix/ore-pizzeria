                        ...
                        <div class="dash-mov-item">
                            ...
                            <div style="text-align:right">
                                ...
                                <button class="btn-mov-delete"
                                    data-key="${this.escapeHtml(key)}" data-type="${this.escapeHtml(m.type)}" data-amount="${m.amount}"
                    ...
                    sortedProducts.forEach(([name, count]) => {
                        ...
                        visualHTML += `
                            <div class="visual-bar-item">
                                <div class="visual-header"><span>${this.escapeHtml(name)}</span><span>${count}</span></div>
