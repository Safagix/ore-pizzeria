...
const app = {
    ...
    hashPin: async function (pin) {
        if (!window.crypto || !window.crypto.subtle) {
            console.error("Web Crypto API not available. Ensure you are in a secure context (HTTPS/localhost).");
            alert("Error de Seguridad: Esta aplicación requiere una conexión segura (HTTPS o localhost) para verificar el PIN. Contacte al administrador.");
            return null;
        }
    ...
    login: async function () {
        ...
        if (!pinHash) return alert("Error de seguridad: No se pudo verificar el PIN.");
