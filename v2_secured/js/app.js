...
const app = {
    ...
    login: async function () {
        ...
        if (pinHash === null) {
            return alert("Error de seguridad: El sistema criptográfico seguro no está disponible en este entorno. Asegúrate de acceder al sitio usando HTTPS o localhost.");
        }
