                        ...
                        <div class="dash-mov-item">
                            ...
                            <div style="text-align:right">
                                ...
                                <button class="btn-mov-delete"
                                        ...
                                        onclick="app.deleteMovement(this.dataset.key, this.dataset.type, parseFloat(this.dataset.amount))">×</button>
                            </div>
                        </div>
                    `;
                }
            ...
            list.innerHTML += `
                <div class="ticket" style="width: 280px; border-color: ${o.payStatus === 'paid' ? 'var(--success)' : 'var(--pending)'}; position: relative;">
                    ...
                    <div class="ticket-body">
                        ...
                        Pago: <b>${app.escapeHtml(o.payStatus) === 'paid' ? 'PAGADO' : 'PENDIENTE'}</b>
                    </div>
